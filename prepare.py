...
def prep_env():
    ...
    parser.add_argument('--val_size', type=int, default=20, help='Number of days for validation')
    parser.add_argument('--test_size', type=int, default=25, help='Number of days for testing')
    ...
    parser.add_argument('--num_workers', type=int, default=7, help='#workers for data loader')
